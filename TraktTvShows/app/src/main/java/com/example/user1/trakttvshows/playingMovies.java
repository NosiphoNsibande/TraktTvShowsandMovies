...
public class playingMovies extends AppCompatActivity {

    private static final String TAG = playingMovies.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<MovieResponse> call = apiService.getnowPlay(API_KEY);
